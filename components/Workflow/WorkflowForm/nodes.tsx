...
export type HttpRequestNode = Node<CustomNodeData, "HttpRequestNode">;
export const HttpRequestNodeComponent: React.FC<NodeProps<HttpRequestNode>> = memo(
  ({ data, selected }) => {
    const borderColor = selected ? "border-blue-500" : "border-gray-200";
    ...
    return (
      <div
        ...
        <div className="flex items-center">
          <div className="mr-1 flex h-6 w-6 items-center justify-center text-gray-500">
            <Icon icon="carbon:http" fontSize={16} />
          </div>
          <div>
            <div className="text-xs font-medium text-gray-700">{data.label}</div>
          </div>
...
export type RerankNode = Node<CustomNodeData, "RerankNode">;
export const RerankNodeComponent: React.FC<NodeProps<RerankNode>> = memo(
  ({ data, selected }) => {
    const borderColor = selected ? "border-blue-500" : "border-gray-200";
...
export type TranslatePairNode = Node<CustomNodeData, "TranslatePairNode">;
export const TranslatePairNodeComponent: React.FC<NodeProps<TranslatePairNode>> = memo(
  ({ data, selected }) => {
    const borderColor = selected ? "border-blue-500" : "border-gray-200";
