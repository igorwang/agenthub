  ...
  return (
    <div className="flex flex-col gap-4 p-4">
      ...
      <div className="text-default-500">
        {t("This node is used to input data for the workflow")}.
        {t("System parameters are automatically generated by the system")}.
        {t("You can customize additional input parameters through the input schema")}.
      </div>
      <CustomForm
