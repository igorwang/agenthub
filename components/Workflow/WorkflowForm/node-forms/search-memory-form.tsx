...
interface SearchMemoryNodeFormProps {
  node: Node<NodeData>;
  prevNodes?: Node[];
...
export default function SearchMemoryNodeForm({
  node,
  prevNodes,
  workflowTestResult,
  onNodeChange,
  onToggleDrawer,
}: SearchMemoryNodeFormProps) {
  ...
  return (
    <div className="flex flex-col gap-4 p-4">
      <div className="text-2xl font-bold">{t("Edit SearchMemory Node")}</div>
      <Divider />
      <CustomForm
