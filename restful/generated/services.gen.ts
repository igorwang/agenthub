...
import type {
  ...
  ExtractionV1NodeExtractionPostData,
  ExtractionV1NodeExtractionPostResponse,
  ...
  SearchV1ChatSearchPostResponse,
...
export class WorkNodeService {
   ...
   * @throws ApiError
   */
  public static extractionV1NodeExtractionPost(
    data: ExtractionV1NodeExtractionPostData,
  ): CancelablePromise<ExtractionV1NodeExtractionPostResponse> {
    return __request(OpenAPI, {
      method: "POST",
...
export class ChatService {
   ...
   * @throws ApiError
   */
  public static searchV1ChatSearchPost(
    data: SearchV1ChatSearchPostData,
  ): CancelablePromise<SearchV1ChatSearchPostResponse> {
    return __request(OpenAPI, {
      method: "POST",
      url: "/v1/chat/search",
      body: data.requestBody,
